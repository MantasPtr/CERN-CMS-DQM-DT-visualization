from machineLearning.logic import getScoreForMatrix, getScoreForData
import unittest
...
class NetTest(unittest.TestCase):
    ...
    def testLine(self):
        ...
        rez = getScoreForMatrix(matrix)
        print(f"Line rez: {len(rez)}")
    ...
    def testData(self):
        data =[{"matrix": [[ i for i in range(47)] for a in range(10)]} for b in range(20)]
        rez = getScoreForData(data)
        print(f"dataRez: {rez}")

    # for unit in data:
    #     # print(f"evaluating: {unit}")
    #     unit["scores"] = getScoreForMatrix(unit["matrix"])
